...
DROP TABLE IF EXISTS chmm_user_info cascade;
...
(
	...
	ACCESS_TOKEN       text        	 NOT NULL COMMENT 'AccessToken',
	REFRESH_TOKEN      text        	 NOT NULL COMMENT 'RefreshToken',
	EXPIRY_DATE        datetime   	 NOT NULL COMMENT '토큰유효기간',
	SYS_INSERT_DTM     datetime   	 DEFAULT NULL COMMENT '등록시간',
	SYS_INSERT_USER_ID varchar(255)	 DEFAULT NULL COMMENT '등록자ID',
	PRIMARY KEY (SEQ)
);
...
CREATE TABLE CHMM_ERROR_LOGGING  (
	ERROR_LOGGING_ID			bigint NOT NULL AUTO_INCREMENT
...
CREATE TABLE chmm_user_access_logging (
	USER_ACCESS_LOGGING_ID bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE CHMM_PRIVACY_POLICY_INFO (
	`POLICY_ID` bigint NOT NULL COMMENT '정책ID',
	`POLICY_VERSION` varchar(10) NOT NULL COMMENT '정책 버전',
	`POLICY_NOTICE_DT` varchar(10) DEFAULT NULL COMMENT '공지일자',
	`POLICY_START_DT` varchar(10) DEFAULT NULL COMMENT '시작일자',
	`POST_YN` char(1) NOT NULL DEFAULT '0' COMMENT '적용여부',
	`SYS_INSERT_DTM` datetime NOT NULL COMMENT '입력 일시',
	`SYS_INSERT_USER_ID` varchar(255) DEFAULT NULL COMMENT '입력자 ID',
	`SYS_UPDATE_DTM` datetime DEFAULT NULL COMMENT '수정 일시',
	`SYS_UPDATE_USER_ID` varchar(255) DEFAULT NULL COMMENT '수정자 ID',
...
CREATE TABLE CHMM_PRIVACY_POLICY_SUB_INFO (
	`POLICY_ID` bigint NOT NULL COMMENT '정책ID',
	`POLICY_SUB_VERSION` bigint NOT NULL COMMENT '정책 하위 버전',
	`TITLE` varchar(255) NOT NULL COMMENT '정책 제목',
	`CONTENT` text NOT NULL COMMENT '정책 내용',
...
DROP TABLE IF EXISTS `CHMM_USER_PREVIOUS_PASSWORDS`;
CREATE TABLE `CHMM_USER_PREVIOUS_PASSWORDS` (
	`PREVIOUS_PASSWORDS_ID` INT AUTO_INCREMENT PRIMARY KEY,
...
(
	...
	,SYS_UPDATE_DTM         TIMESTAMP       DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
